...
import com.bd.compiler.x64codegen.X64AssemblyGenerator;
import com.bd.compiler.parser.*;
import com.bd.compiler.lowlevel.*;
import java.util.*;
import java.io.*;
import com.bd.compiler.optimizer.*;
import com.bd.compiler.x86codegen.*;
import com.bd.compiler.x64codegen.*;
import com.bd.compiler.dataflow.*;
...
public class CMinusCompiler implements Compiler {
    ...
    public void compile(String filePrefix) {
        ...
        try {
            ...
            System.out.println(parseTree.printTree());
...
//    du.printAnalysis();
    ...
    public static void main(String[] args) {
        String filePrefix = "src\\main\\java\\com\\bd\\compiler\\tests\\testcode";
